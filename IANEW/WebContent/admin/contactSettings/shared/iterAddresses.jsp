...
<s:iterator value="contact.addressesList" status="stat">
	<section class="sixteen columns curveBorder">
		...
		<s:hidden name="contact.addressesList[%{#stat.index}].id"/>			
		<div class="row">
			<div class="inputfield eight columns">
				<s:label for="address" value="Street" />
				<div><s:textfield name="contact.addressesList[%{#stat.index}].street" /></div>
			</div>
			<div class="inputfield four columns">
				<s:label for="city" value="Suburb" />
				<div><s:textfield name="contact.addressesList[%{#stat.index}].suburb" /></div>
			</div>
			<div class="inputfield three columns">
				<s:label for="state" value="State:" />
				<div><s:textfield name="contact.addressesList[%{#stat.index}].state" /></div>
			</div>
		</div>
		...
		<div class="row">
			<div class="inputfield four columns">
				...
				<div><s:textfield name="contact.addressesList[%{#stat.index}].country"></s:textfield></div>
			</div>
			<div class="inputfield four columns">
				<s:label for="postCode" value="Post Code:" />
				<div><s:textfield name="contact.addressesList[%{#stat.index}].postcode"></s:textfield></div>
			</div>
			<div class="inputfield four columns">
				<s:label for="homePhone" value="Home#:"/>
				<div><s:textfield name="contact.addressesList[%{#stat.index}].homephone"></s:textfield></div>
			</div>
		</div>
	</section>
</s:iterator>
