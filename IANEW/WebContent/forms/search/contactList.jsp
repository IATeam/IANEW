...
$("#btnSelectContact").click(function(){
	...
	if($("#formTitle").text() == "New Enquiry" || $("#formTitle").text() == "Existing Enquiry"){
		if($("#selectedContact").val() !== ""){
			$("#contactInfo").load("/IANEW/enquiry/assignContact.action?contactid=" + contactid + "&call=1");
			
			$("#divDanger").load("/IANEW/enquiry/assignContact.action?contactid=" + contactid + "&call=2");
			
			sent = true;
		}
	}else if($("#formTitle").text() == "New Case" || $("#formTitle").text() == "Existing Case"){
		if($("#selectedContact").val() !== ""){
			$("#contactInfo").load("/IANEW/case/assignContact.action?contactid=" + contactid + "&call=1");
			$("#divDanger").load("/IANEW/case/assignContact.action?contactid=" + contactid + "&call=2");
